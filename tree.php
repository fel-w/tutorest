        ...
        <body>
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Tree Data Structure-->
                        <div class="topic-pill active-accordion">Tree Data Structure</div>
						<div class="panel-active">
                            <p class="active-panel">Tree Traversal</p>
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Tree Traversal</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=trees-bin"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=graphs-BFT"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <!--
                End of Topic - Tree Traversal
            -->
            
            
            <?php } elseif($a == "trees-bin"){?>
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Tree Data Structure-->
						...
						<div class="panel-active">
                            ...
                            <p class="active-panel">Binary Search Tree</p>
							<a href="?action=trees-AVL"><p class="subtopic-pill">AVL Tree</p></a>
							<a href="?action=trees-span"><p class="subtopic-pill">Spanning Tree</p></a>
							<a href="?action=trees-heap"><p class="subtopic-pill">Heap</p></a>
						</div>
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Binary Search Tree</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=trees-AVL"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=trees"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <!--
                End of Topic - Binary Search Tree
            -->
            
            
            <?php } elseif($a == "trees-AVL"){?>
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Tree Data Structure-->
						...
						<div class="panel-active">
							<a href="?action=trees"><p class="subtopic-pill">Tree Traversal</p></a>
                            <a href="?action=trees-bin"><p class="subtopic-pill">Binary Search Tree</p></a>
                            <p class="active-panel">AVL Tree</p>
							<a href="?action=trees-span"><p class="subtopic-pill">Spanning Tree</p></a>
							<a href="?action=trees-heap"><p class="subtopic-pill">Heap</p></a>
						</div>
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>AVL Tree</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=trees-span"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=trees-bin"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Tree Data Structure-->
						...
						<div class="panel-active">
                            ...
                            <a href="?action=trees-bin"><p class="subtopic-pill">Binary Search Tree</p></a>
                            <a href="?action=trees-AVL"><p class="subtopic-pill">AVL Tree</p></a>
                            <p class="active-panel">Spanning Tree</p>
							<a href="?action=trees-heap"><p class="subtopic-pill">Heap</p></a>
						</div>
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Spanning Tree</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=trees-heap"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=trees-AVL"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <!--
                End of Topic - Spanning Tree
            -->
            
            
            <?php } elseif($a == "trees-heap"){?>
            ...
            <div class="container-fluid main-container">
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Heap</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <div class="next-inactive"><p>Next »</p></div>
                            <a href="?action=trees-span"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
