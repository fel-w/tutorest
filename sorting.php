        ...
        <body>
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Sorting Techniques-->
                        <div class="topic-pill active-accordion">Sorting Techniques</div>
                        <div class="panel-active">
                            <p class="active-panel">Bubble Sort</p>
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Bubble Sort</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=sort-ins"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=search-bin"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <!--
                End of Topic - Bubble Sort
            -->
            
            
            <?php } elseif($a == "sort-ins"){?>
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Sorting Techniques-->
                        ...
                        <div class="panel-active">
                            ...
                            <p class="active-panel">Insertion Sort</p>
							<a href="?action=sort-sel"><p class="subtopic-pill">Selection Sort</p></a>
							<a href="?action=sort-merg"><p class="subtopic-pill">Merge Sort</p></a>
							<a href="?action=sort-quick"><p class="subtopic-pill">Quick Sort</p></a>
						</div>
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Insertion Sort</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=sort-sel"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=sort-bbo"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <!--
                End of Topic - Insertion Sort
            -->            
            
            <?php } elseif($a == "sort-sel"){?>
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Sorting Techniques-->
                        ...
                        <div class="panel-active">
                            <a href="?action=sort-bbo"><p class="subtopic-pill">Bubble Sort</p></a>
							<a href="?action=sort-ins"><p class="subtopic-pill">Insertion Sort</p></a>
                            <p class="active-panel">Selection Sort</p>
							<a href="?action=sort-merg"><p class="subtopic-pill">Merge Sort</p></a>
							<a href="?action=sort-quick"><p class="subtopic-pill">Quick Sort</p></a>
						</div>
					<!--End of Sorting Techniques-->
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Selection Sort</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=sort-merg"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=sort-ins"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <!--
                End of Topic - Selection Sort
            -->
            
            
            <?php }elseif($a == "sort-merg"){?>
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Sorting Techniques-->
                        ...
                        <div class="panel-active">
							...
							<a href="?action=sort-ins"><p class="subtopic-pill">Insertion Sort</p></a>
							<a href="?action=sort-sel"><p class="subtopic-pill">Selection Sort</p></a>
                            <p class="active-panel">Merge Sort</p>
							<a href="?action=sort-quick"><p class="subtopic-pill">Quick Sort</p></a>
						</div>
					<!--End of Sorting Techniques-->
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Merge Sort</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=sort-quick"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=sort-sel"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <!--
                End of Topic - Merge Sort
            -->
            
            
            <?php } elseif($a == "sort-quick"){?>
            <!--
                Topic - Quick Sort
            -->            
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Sorting Techniques-->
                        ...
                        <div class="panel-active">
							...
							<a href="?action=sort-sel"><p class="subtopic-pill">Selection Sort</p></a>
                            <a href="?action=sort-merg"><p class="subtopic-pill">Merge Sort</p></a>
                            <p class="active-panel">Quick Sort</p>
						</div>
					<!--End of Sorting Techniques-->
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Quick Sort</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=graphs-DFT"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=sort-merg"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
