...
<!DOCTYPE html>
    <html lang="en">
        ...
        <body>
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Graph Data Structure-->
                        <div class="topic-pill active-accordion">Graph Data Structure</div>
						<div class="panel-active">
                            <p class="active-panel">Depth First Traversal</p>
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Depth First Traversal</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=graphs-BFT"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=sort-quick"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <!--
                End of Topic - Depth First Traversal
            -->
            
            
            <?php } elseif ($a == "graphs-BFT"){ ?>
            ...
            <div class="container-fluid main-container">
                ...
                <nav class="collapse navbar-collapse" id="topics">
					...
					<!--Graph Data Structure-->
						...
						<div class="panel-active">
                            ...
                            <p class="active-panel">Breadth First Traversal</p>
						</div>
					<!--End of Graph Data Structure-->
                ...
                <!--End of Topics Navigation-->
                 ...
                 <!--Content-section-->
                    <div class="content-section">
                        <div class="title"><p>Breadth First Traversal</p></div>
                        <hr>
                        <!--Content-nav-->
                        <div class="content-nav">
                            <a href="?action=trees"><div class="next"><p>Next »</p></div></a>
                            <a href="?action=graphs-DFT"><div class="previous"><p>« Previous</p></div></a>
                            <div class="clr"></div>
                        </div>
                        <hr>
                        <!--End of Content-nav-->
            ...
            <!--
                End of Topic - Breadth First Traversal
            -->
